...
idea.module.settings.packagePrefix.apply {
    set("src/main/kotlin", "com.kimd13.characterprofilepresentation")
    set("src/test/kotlin", "com.kimd13.characterprofilepresentation")
    set("src/androidTest/kotlin", "com.kimd13.characterprofilepresentation")
}

android {
    namespace = "com.kimd13.characterprofilepresentation"
